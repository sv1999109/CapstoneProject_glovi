...
function Shipping() {
    ...
    return (
        <>
            <Header />
            <div className="ShippingeBody">
            <div id="HeaderSpace"></div>
            <h1 style={{ fontWeight: 'bold', fontSize: '30px' }}>Where are you shipping?</h1>
            ...
            <h1 style={{ fontWeight: 'bold', fontSize: '30px' }}>What are you shipping?</h1>
            ...
            <div id="estimateResultsection" className="estimate-sections">
                <div id="estimateSubmitButtonBox"><button id="submitEstimateForm">Create Shipment</button></div>
