<head>
    ...
    <title> <?php echo e($page_title); ?> |
        <?php echo e(get_content_locale(get_config('site_name'), LaravelLocalization::getCurrentLocale())); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset(get_theme_dir('assets'))); ?>/bootstrap/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet"
        href="<?php echo e(asset(get_theme_dir('assets_dashboard'))); ?>/vendors/bootstrap-icons/font/bootstrap-icons.css">

    
    <link rel="stylesheet" href="<?php echo e(asset(get_theme_dir('assets'))); ?>/css/theme.css?v1" type="text/css" media="all">
    ...
    <link rel="stylesheet" href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/lazyload/lazyload.css" type="text/css"
        media="all">
    <link rel="stylesheet" href="<?php echo e(asset(get_theme_dir('assets'))); ?>/css/animate.css" type="text/css" media="all">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/slick/slick.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/slick/slick-theme.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/owlcarousel/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/owlcarousel/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset(get_theme_dir('plugins'))); ?>/owlcarousel/owl.theme.default.min.css">
...
<?php /**PATH /home/ansabook/glovi.ansabooks.com/resources/views/themes/greenship/layouts/partials/head.blade.php ENDPATH**/ ?>