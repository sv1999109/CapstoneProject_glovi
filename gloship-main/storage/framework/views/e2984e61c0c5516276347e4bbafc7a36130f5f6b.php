...
<div id="hero-section" class="hero-section">
    <div class="hero-wrapper call-to-action-below h-100">
        <div class="hero-vector"><img src="<?php echo e(asset('assets/img/hero-vector.svg')); ?>" alt="hero vector">
        </div>
        <div class="container">
            <div class="row mt-4 mb-5  hero-center">
                <div class="col-lg-12 call-to-action-invite">
                    ...
                    <h1 class="text-bold text-capitalize typed-text" style="display: none">
                        <?php echo e(get_content_locale(get_contents('home_hero_title'))); ?>,, <?php echo nl2br(get_content_locale(get_contents('home_hero_desc'))); ?></h1>

                </div>
                <div class="col-lg-12 call-to-action-button mt-5">
                    <form action="<?php echo e(route('tracking')); ?>">
                            ...
                            <div class="card-body px-lg-4 ">
                                ...
                                <div class="form-group mb-3">
                                    <input style=" border-radius: 8px; font-size: 12px;" type="text" name="code"
                                        ...
                                        placeholder="<?php echo app('translator')->get('messages.Tracking_Number_Input'); ?>" required>
                        ...
                        <div class="mt-3">
                            <button class="btn btn-blue btn-block w-100"><span class="me-3"><?php echo app('translator')->get('messages.Track'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ansabook/glovi.ansabooks.com/resources/views/themes/greenship/home/sections/hero.blade.php ENDPATH**/ ?>