...
return [
    ...
    */
    ...
    "boolean" =>  "El campo El :attribute debe ser verdadero o falso.",
    "confirmed" =>  "La confirmación La:attribute no coincide.",
    ...
    "different" =>  "'The' :attribute y :other deben ser diferentes.",
    ...
    "distinct" =>  "El campo El :attribute tiene un valor duplicado.",
    ...
    "not_regex" =>  "El formato El :attribute no es válido.",
    "numeric" =>  "El :attribute debe ser un número.",
    "password" =>  "'La contraseña es incorrecta.",
    "present" =>  "El campo :attribute debe estar presente.",
    "prohibited" =>  "El campo El :attribute está prohibido.",
    "prohibited_if" =>  "El campo :attribute está prohibido cuando :other es :value.",
    "prohibited_unless" =>  "El campo :attribute está prohibido a menos que :other esté en :values.",
    "prohibits" =>  "El campo :attribute prohíbe que :other esté presente.",
    "regex" =>  "El formato El :attribute no es válido.",
