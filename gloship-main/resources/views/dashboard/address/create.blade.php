    ...
    <div class="row">
        <div class="col-md-12x">
            <div class="card">
                ...
                <hr class="divider">
                <form id="address_create_form" data-action="{{ route('dashboard.address.create') }}" class="form"
                    method="post">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if (isset($user))
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        <label
                                            class="form-label required">{{ trans_choice('messages.Customer', 1) }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label required">@lang('messages.Address_Type')</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="hidden" value="{{ old('phone', $phone) }}" name="phone"
