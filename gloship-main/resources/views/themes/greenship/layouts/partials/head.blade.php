<head>
    ...
    {{-- Site Style Sheet --}}
    <link rel="stylesheet" href="{{ asset(get_theme_dir('assets')) }}/css/theme.css?3" type="text/css" media="all">
    ...
    {{-- CSS Plugins --}}
    <link rel="stylesheet" href="{{ asset(get_theme_dir('plugins')) }}/preloader/preloader.css" type="text/css">
