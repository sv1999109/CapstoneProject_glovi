            ...
            <div class="col-md-6 col-sm-8">
                <div class="title-wrap">
                    <h2 class="section-title wow fadeInLeft" data-wow-offset="50" data-wow-delay=".20s"
                        style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInLeft;">{{ trans_choice('messages.Customer_Support', 1) }}</h2>
...
@push('css')
    <style>
        .contact-wrap {
            background-image: url({{ asset('assets/img/MAP.png') }});
