...
<div class="faqs bg-white wow fadeInUp">
    <div class="container pe-50 pt-5">
        <div class="section-title position-relative text-center mx-auto pb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s"
            ...
            <h2 class="mb-3">{!! nl2br(get_content_locale(get_contents('home_faq_title'))) !!}</h2>
            <p class="mb-1">{!! nl2br(get_contents('home_faq_desc')) !!}</p>
        </div>
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header s-title text-primary" id="a{{ $post_id }}">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#faq-{{ $post_id }}" aria-expanded="true"
                                aria-controls="a-{{ $post_id }}">
                        ...
                        <div id="faq-{{ $post_id }}" class="accordion-collapse collapse"
                            aria-labelledby="a-{{ $post_id }}" data-bs-parent="#accordionFlushExample">
        ...
        style="max-width: 600px;">
        <a href="{{ route('pages', ['slug' => 'faq']) }}"><span class="fa fa-arrow-right me-2"></span> More Question &amp; Answer</a>
