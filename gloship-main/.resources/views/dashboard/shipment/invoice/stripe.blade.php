        ...
        <div class="card small-card">
            ...
            @endif
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-text">
                            <form action="{{ route('dashboard.shipments.invoice.payment.process', ['id' => $id]) }}" method="post" id="payment-form">
                                @csrf
                                <div>
                ...
                <div class="text-center">
                    <img class="pt-4" style="width: 120px; height: auto" src="{{ asset(get_theme_dir('assets_dashboard')) }}/images/stripe.webp" alt="Powered by Stripe">
                </div>
