    ...
    <section class="main-pd-wrapper" style="width: 1000px; margin: auto">
      <div style="display: table-header-group">
        <div class="no-print">
            ...
            <span style="margin: 0; text-align: right; float: right;"><a  href="#" onclick="window.print();">@lang('messages.Print')</a></span>
        </div>
    ...
    <tr>
        ...
        <td>
          <h4 style="margin: 0; text-align: right" class="no-print">
              <a href="#" onclick="window.print();">@lang('messages.Print')</a>
          </h4>
        </td>
      </tr></table>
    </section>
